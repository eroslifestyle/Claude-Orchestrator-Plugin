...
## [V10.1.0] - 2026-02-21 - INSTALLER UPDATE

### Added

#### Unix/Mac Installer
- **setup.sh**: Complete bash installer for Unix/Mac systems
- **Shell detection**: Automatic detection of bash/zsh and appropriate RC file
- **Interactive component selection**: User-friendly menu with silent mode support
- **Profile merge**: Smart merge of shell profile with existing configurations
- **API key configuration**: Interactive Z.AI API key setup during installation
- **Version tracking**: VERSION.json creation for update management
- **Prerequisites check**: Validation of shell version, permissions, and required tools
- **Force mode**: Option to overwrite existing files
- **Help system**: Built-in help with usage examples

### Changed
- **setup.ps1**: PowerShell installer now matches Unix installer functionality
...
**ORCHESTRATOR V10.0 ULTRA | FULLY INTEGRATED EDITION**
